...
const Home = () => {
  ...
  const PHONE = "(443) 401-1264";
  const EMAIL = "otisj4502@gmail.com";
  const MC_NUMBER = "1599602";
  const DOT_NUMBER = "4162196";
  const HOME_BASE = "4500 RIDGE RD NOTTINGHAM, MD 21236";
  ...
  const handleDownload = (docName) => {
    ...
    fetch(filePath)
      ...
      .then(blob => {
        ...
        link.href = url;
        link.setAttribute('download', `${docName.replace(/\s+/g, '_')}_PT.jpg`);
  ...
  const handleUnlock = (e) => {
    e.preventDefault();
    if (accessCode.toUpperCase() === 'PT2026') {
      setIsUnlocked(true); 
      setShowModal(false); 
      setError('');
    } else { 
      setError('Invalid Code. Try "PT2026"'); 
    }
  };
  ...
  const handleQuoteRequest = (e) => {
    ...
    const subject = encodeURIComponent(`Quote Request: ${quoteOrigin} to ${quoteDest} - Paye's Trucking LLC`);
    const body = encodeURIComponent(
      `Hi Payes,\n\nI am reaching out to request a quote for a load moving from ${quoteOrigin} to ${quoteDest}.\n\nEquipment Required: 26ft Box Truck\nCarrier: Paye's Trucking LLC (MC# ${MC_NUMBER})\n\nPlease let me know your availability and rate for this lane.\n\nBest regards,`
    );
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up z-20">
            ...
            <h1 className="text-5xl md:text-7xl font-black leading-none tracking-tight text-gray-900">
              <span className="text-gradient bg-clip-text text-transparent bg-gradient-to-r from-red-600 to-red-400">Paye's </span><br />Trucking LLC
            </h1>
          ...
          <div className="relative w-full h-full animate-fade-in-up" style={{animationDelay: '0.2s'}}>
            <div className="clip-trap relative z-10 bg-gray-800 aspect-[4/5] shadow-2xl group overflow-hidden">
              <img 
                src={heroTruck} 
                alt="Payes Trucking LLC 26ft International Box Truck" 
        ...
        <div className="max-w-6xl mx-auto px-4 grid grid-cols-1 md:grid-cols-2 gap-16 items-center relative z-10">
           {/* Image Side */}
            <div className="relative group hover-lift">
              ...
              <img 
                src={driverImg} 
                alt="Moses Payes - Owner Operator" 
              ...
              <div className="absolute bottom-6 left-6 bg-black/80 backdrop-blur-md px-6 py-4 border-l-4 border-red-600 shadow-lg">
                <p className="font-black text-xl uppercase text-white">Moses Payes</p>
          ...
          <div className="space-y-6">
              ...
              <p className="text-lg text-gray-600 leading-relaxed border-l-4 border-red-200 pl-4">
                "I operate under my own authority to kill the anxiety brokers feel when they hang up the phone. When you book Payes Trucking LLC, you aren't talking to a dispatcher—you're talking to the driver. 
                <br/><br/>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="relative group clip-trap bg-gray-200 shadow-xl overflow-hidden h-[400px] lg:h-auto">
              <img 
                src={truckRear} 
                alt="Payes's 3000lb Anthony Liftgate Proof" 
                className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
              />
      ...
      <section className="py-20 bg-gray-900 text-white clip-angle">
        <div className="max-w-7xl mx-auto px-4">
           ...
           <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {[
                { name: "Jason M.", company: "TQL", text: "Payes was excellent. Perfect for that tricky LTL run we had. Tracking was on point." },
